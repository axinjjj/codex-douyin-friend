...
const SAFE_ACTION_PATTERN = /^(?:start|pause|stop|reconnect|compact|rotateThread|setAutoSend|setModelEffort)$/u;
...
<body>
  <main>
    ...
    <section class="panel controls">
      <div class="panel-head"><h2>运行控制</h2><label class="switch"><input id="autoSend" type="checkbox"> 自动发送回复</label></div>
      <div class="buttons">
