...
<body>
  <main>
    ...
    <section class="panel controls">
      ...
      <p class="hint">开启自动发送后，当前聊天内容与媒体理解会进入并保留在持久 Codex 任务中；只应用于一个你信任的好友和专用账号。</p>
    </section>
  </main>
