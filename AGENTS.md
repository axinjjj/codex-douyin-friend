...
- Supervisor terminal events are strict allowlists. Deterministic ambiguity blocks; recoverable idle failures use the documented bounded backoff. Never weaken a gate to keep the dashboard green.
