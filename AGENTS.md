...
- Live media probes on 2026-09-02 exposed the former compound-message, zero-width direction, background-screenshot, and null-detail failures. After correction, the current real direct-image data payload and share-card cover both completed bounded local acquisition and immediate cleanup. A Codex reply round trip still requires explicit clearing of the currently blocked test checkpoint.
